...
class DefaultRepositoryCollector {
    ...
    DefaultRepositoryCollector(Collection<Class<? extends AggregateRoot>> aggregateClasses, Collection<Class<? extends Repository>> defaultRepositoryImplementations, Application application) {
